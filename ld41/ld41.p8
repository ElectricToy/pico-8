...
function draw_ui()
	...
	function draw_fullicon_stat( top, stat, max, full_sprite, empty_sprite )
        ...
        draw_halveable_stat( iconsy, player.health, player.max_health, 1, 2, 3 )
	...
	draw_fullicon_stat( iconsy, player.armor, player.max_armor, 7, 8 )
        draw_shadowed( 2, iconsy + 1, 0, 1, 1, function(x,y)
            print( 'def.', x, y, 6 )
        end )
        ...
        draw_halveable_stat( iconsy, player.satiation, player.max_satiation, 4, 5, 6 )
        draw_shadowed( 2, iconsy + 1, 0, 1, 1, function(x,y)
            print( 'food', x, y, 9 )
        end )
