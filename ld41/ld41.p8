...
function level:update_mapsegments()
    ...
    if #self.mapsegments > 0 then
        firstopenleft = max( left, self.mapsegments[ #self.mapsegments ].worldx + maptoworld( mapsegment_tile_size.x ) )
    end
    for worldcellx = world_to_mapsegment_cell_x( firstopenleft ), world_to_mapsegment_cell_x( right ) do
        ...
        -- debug_print( 'created segment ' .. segment.worldx )
    end
...

...

__sfx__
