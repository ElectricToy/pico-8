...
function mapsegment:colliding_tile( withactor )
    ...
    local my_mapspace_ul = { x = flr( self.segment_num % 16 ) * 8, 
                             y = flr( self.segment_num / 16 ) * 16 }

    rect.l = flr( rect.l / 8 ) + my_mapspace_ul.x
    rect.t = flr( rect.t / 8 ) + my_mapspace_ul.y
    rect.r = flr( rect.r / 8 ) + my_mapspace_ul.x
    rect.b = flr( rect.b / 8 ) + my_mapspace_ul.y
    ...
    for y = rect.t, rect.b do
        for x = rect.l, rect.r do
            if fget( mget( x, y ), 7 ) then
                local tileworldspace = vector:new( myrect.l + ( x - my_mapspace_ul.x ) * 8, myrect.t + ( y - my_mapspace_ul.y ) * 8 )
                -- debug_print( x .. ',' .. y .. ' ' .. rect.l .. ',' .. rect.t .. ' ' .. myrect.l .. ',' .. myrect.t .. ' ' )
                debug_print( tileworldspace.x .. ',' .. tileworldspace.y )
...
function level:update_collision()
    ...
    if self.player.vel.y >= 0 then
        for segment in all( self.mapsegments ) do
            ...
            if collision ~= nil and footheight < collision.y + 8 then
...

